...
public class WO_006_OP_01 extends Hooks {
	 ...
	 * is successfully placed. The order should be successfully placed, and a confirmation
	 * message should be displayed. The order is successfully placed, and a confirmation
