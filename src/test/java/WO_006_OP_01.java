...
public class WO_006_OP_01 extends Hooks {
     ...
     * The order should be successfully placed, and a confirmation message should be displayed. The order is successfully placed, and a confirmation message is displayed
     */
    ...
    void testVerifyOrderPlacement() {
        ...
        assertEquals("New order has been successfully added.", verifyMessage, "new order message should be after ordering");
        ...
        for (int i = 0; i < orderInput.size(); i++) {
            assertEquals(orderInput.get(i), dataOfLastOrder.get(i + 1).getText());
        }
